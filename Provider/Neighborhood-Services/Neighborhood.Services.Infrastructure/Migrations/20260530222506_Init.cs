        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    subscribedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2026, 5, 30, 22, 25, 5, 664, DateTimeKind.Utc).AddTicks(7616)),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    TechnicianId1 = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AvailabilityExceptions_Technicians_TechnicianId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicianId1 = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Favorites_Technicians_TechnicianId1",
                        column: x => x.TechnicianId1,
                        principalTable: "Technicians",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TechnicianCategories_Technicians_TechnicianId1",
                        column: x => x.TechnicianId1,
                        principalTable: "Technicians",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TechnicianPricings_Technicians_TechnicianId1",
                        column: x => x.TechnicianId1,
                        principalTable: "Technicians",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Invoices_Technicians_TechnicianId1",
                        column: x => x.TechnicianId1,
                        principalTable: "Technicians",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    createdAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2026, 5, 30, 22, 25, 5, 663, DateTimeKind.Utc).AddTicks(9687)),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityExceptions_TechnicianId1",
                table: "AvailabilityExceptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_TechnicianId1",
                table: "Favorites",
                column: "TechnicianId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_TechnicianId1",
                table: "Invoices",
                column: "TechnicianId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnicianCategories_TechnicianId1",
                table: "TechnicianCategories",
                column: "TechnicianId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnicianPricings_TechnicianId1",
                table: "TechnicianPricings",
                column: "TechnicianId1");
